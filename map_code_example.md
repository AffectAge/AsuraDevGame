...
export class OffsetCoord
{
    ...
    {
        var parity:number = h.q & 1;
        var col:number = h.q;
        var row:number = h.r + (h.q + offset * parity) / 2;
    ...
    {
        var parity:number = h.col & 1;
        var q:number = h.col;
        var r:number = h.row - (h.col + offset * parity) / 2;
        var s:number = -q - r;
        if (offset !== OffsetCoord.EVEN && offset !== OffsetCoord.ODD)
        {
            throw "offset must be EVEN (+1) or ODD (-1)";
    ...
    {
        var parity:number = h.r & 1;
        var col:number = h.q + (h.r + offset * parity) / 2;
        var row:number = h.r;
        if (offset !== OffsetCoord.EVEN && offset !== OffsetCoord.ODD)
        {
            throw "offset must be EVEN (+1) or ODD (-1)";
    ...
    {
        var parity:number = h.row & 1;
        var q:number = h.col - (h.row + offset * parity) / 2;
        var r:number = h.row;
        var s:number = -q - r;
        if (offset !== OffsetCoord.EVEN && offset !== OffsetCoord.ODD)
        {
